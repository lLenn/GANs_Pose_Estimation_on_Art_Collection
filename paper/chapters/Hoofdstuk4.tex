...
\begin{table}[h]
    ...
    \begin{tabular}{ l|cccccc }
        \hline
        \multirow{2}{*}{\bf{Paper}}&\multicolumn{6}{c}{\bf{Epochs}}\cr
...
\begin{table*}[h]
    ...
    \begin{tabular}{ l|cc|c|cc }
        \hline
        \multirow{2}{*}{Model}&\multicolumn{2}{c|}{\bf{Madhu et al.}}&\multicolumn{1}{c|}{\bf{Kadish et al.}}&\multicolumn{2}{c}{\bf{This thesis}}\cr
