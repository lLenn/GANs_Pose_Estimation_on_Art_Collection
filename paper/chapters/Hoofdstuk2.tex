...
But not really because it only works for top-down networks and the MPII dataset.
Each implementation that I found asserts that the length of predicted persons should be the same as that of the ground truth
So, no \gls{PCK}
