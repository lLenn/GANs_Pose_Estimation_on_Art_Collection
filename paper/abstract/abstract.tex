...
\begin{table}
    ...
    \begin{tabular}{ l|cc|c|cc }
        \hline
        &\multicolumn{2}{c}{\bf{Madhu et al.}}&\multicolumn{1}{c}{\bf{Kadish et al.}}&\multicolumn{2}{c}{\bf{This paper}}\cr
        \hline
...
\onecolumn
\appendix
\subsection{Results Experiments}
\label{appendix:results_experiments}
{
	\begin{table*}[h]
		\setlength\tabcolsep{4pt}
		\vspace{0.2em}
		\caption{
			...
			The table shows the performance of the pre-trained and control models measured on The COCO dataset and the Human-Art dataset.
		}
		\centering
		\normalsize
		...
		\begin{tabular}{ l|ccccc|ccccc }
			...
			Control SWAHR & 0.620 & 0.830 & 0.684 & 0.604 & 0.653 & 0.710 & 0.891 & 0.765 & 0.640 & 0.803 \cr
			Pre-trained ViTPose & 0.588 & 0.832 & 0.641 & 0.573 & 0.629 & 0.723 & 0.906 & 0.782 & 0.682 & 0.786 \cr
			Control ViTPose & 0.609 & 0.847 & 0.680 & 0.597 & 0.644 & \textbf{0.740} & \textbf{0.918} & \textbf{0.810} & \textbf{0.703} & 0.795 \cr
			\hline
			...
			Control SWAHR & 0.492 & 0.742 & 0.536 & 0.058 & 0.539 & 0.563 & 0.784 & 0.606 & 0.109 & 0.605 \cr
			Pre-trained ViTPose & 0.380 & 0.656 & 0.385 & 0.108 & 0.420 & 0.571 & 0.803 & 0.620 & 0.279 & 0.599 \cr
			Control ViTPose & 0.406 & 0.682 & 0.415 & \textbf{0.130} & 0.445 & 0.591 & \textbf{0.818} & \textbf{0.632} & \textbf{0.306} & 0.619 \cr
			\hline
		\end{tabular}
	\end{table*}
